        ...
        return (
            "Confirm a booking, order, appointment, enrollment, or service request.",
            {
                ...
                "properties": {
                    ...
                    "sender_name":               {"type": "string", "description": "The name of the sender/shipper."},
                    "receiver_name":             {"type": "string", "description": "The name of the receiver."},
                    "pickup_address":            {"type": "string", "description": "The detailed pickup address."},
                    "delivery_address":          {"type": "string", "description": "The detailed delivery address."},
                    "parcel_weight_kg":          {"type": "string", "description": "The weight of the parcel, e.g., '10 kg'."},
